...
% nnls solves a nonnegative least-squares problem Cx=d with x>=0.
% This third-party Lawson-Hanson implementation is used by the tomography
% inversion when nonnegative water-vapor densities are required.
